...
export class Service extends DatabaseService<Model> {
  ...
  public async notifyOwnersWhenNoProbeIsEnabled(data: {
    ...
    for (const owner of owners) {
      ...
      const sms: SMSMessage = {
        message: `This is a message from CBS Uptime. Probes for monitor ${monitor.name} is ${enabledStatus}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard.`,
      };

      const callMessage: CallRequestMessage = {
        data: [
          {
            sayMessage: `This is a message from CBS Uptime. Probes for monitor ${monitor.name} is ${enabledStatus}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard. Good bye.`,
          },
        ],
      };
  ...
  public async notifyOwnersProbesDisconnected(data: {
    ...
    for (const owner of owners) {
      ...
      const sms: SMSMessage = {
        message: `This is a message from CBS Uptime. Probes for monitor ${monitor.name} is ${status}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard.`,
      };

      const callMessage: CallRequestMessage = {
        data: [
          {
            sayMessage: `This is a message from CBS Uptime. New monitor was created ${monitor.name}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard. Good bye.`,
          },
        ],
      };
