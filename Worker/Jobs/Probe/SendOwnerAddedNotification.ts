    ...
    for (const probeId in probeOwnersMap) {
      ...
      for (const user of users) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from CBSUptime. You have been added as the owner of the probe: ${probe.name!}. To unsubscribe from this notification go to User Settings in CBSUptime Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from CBSUptime. You have been added as the owner of the probe: ${probe.name!}. To unsubscribe from this notification go to User Settings in CBSUptime Dashboard.  Good bye.`,
            },
          ],
        };
