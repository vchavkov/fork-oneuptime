    ...
    for (const noteObject of notes) {
      ...
      for (const user of owners) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from CBSUptime. New note posted on incident: ${incident.title}. To unsubscribe from this notification go to User Settings in CBSUptime Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from CBSUptime. New note posted on incident ${incident.title}. To see the note, go to CBSUptime Dashboard. To unsubscribe from this notification go to User Settings in CBSUptime Dashboard. Good bye.`,
            },
          ],
        };
