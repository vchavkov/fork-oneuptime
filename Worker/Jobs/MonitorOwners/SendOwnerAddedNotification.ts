    ...
    for (const monitorId in monitorOwnersMap) {
      ...
      for (const user of users) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from CBS Uptime. You have been added as the owner of the monitor - ${monitor.name}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from CBS Uptime. You have been added as the owner of the monitor ${monitor.name}.  To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard. Good bye.`,
            },
          ],
        };
