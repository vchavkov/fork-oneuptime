    ...
    for (const noteObject of notes) {
      ...
      for (const user of owners) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from CBS Uptime. New note posted on alert: ${alert.title}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from CBS Uptime. New note posted on alert ${alert.title}. To see the note, go to CBS Uptime Dashboard. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard. Good bye.`,
            },
          ],
        };
