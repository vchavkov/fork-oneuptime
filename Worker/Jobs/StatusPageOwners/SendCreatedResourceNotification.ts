    ...
    for (const statusPage of statusPages) {
      ...
      for (const user of owners) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from CBS Uptime. New status page created - ${statusPage.name}. To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from CBS Uptime.  New status page created ${statusPage.name}.  To unsubscribe from this notification go to User Settings in CBS Uptime Dashboard. Good bye.`,
            },
          ],
        };
