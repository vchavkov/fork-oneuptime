...
export default class BlogPostUtil {
  ...
  public static async getBlogPostFromGitHub(
    ...
    const blogPost: BlogPost = {
      ...
      blogUrl: `https://uptime.cbsretail.net/blog/post/${fileName}`, // this has to be uptime.cbsretail.net because its used in twitter cards and faceboomk cards. Please dont change this.
    };
